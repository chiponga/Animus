...
Se invalido, devolver opcoes corrigidas (ex: "Especialista SDR Estetica" -> `sdr-estetica`).
...
2. **Hierarquia**: filial da Animus, reporta pra Animus. Nunca fala direto com Chefe sem passar pela Animus.
...
3. **Hierarquia clara**: subagente reporta pra Animus, nao fala com Chefe direto
