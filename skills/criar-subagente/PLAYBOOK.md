...
- SDR de academia vs SDR de personal trainer: tom proximo. ADAPTAR Apollo com referencia de academia.
...
|---|---|---|---|
| Conclusao | ADAPTAR existente | Discutir com Animus | CRIAR novo |
...
5. Validar testando: `Agent(subagent_type="apollo", prompt="qualifique uma clinica de estetica em uma capital brasileira")`
...
- [ ] Hierarquia clara (reporta pra Animus)
