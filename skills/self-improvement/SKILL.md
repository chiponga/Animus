...
## Animus / Claude Code Setup

This skill is used inside the Animus repository with Claude Code. The canonical learning location is the project-level `.learnings/` directory.
...
<project-root>/
  CLAUDE.md
  AGENTS.md                  # optional, if the project uses it
  .learnings/
    LEARNINGS.md
    ERRORS.md
    FEATURE_REQUESTS.md
...
When learnings prove broadly applicable, promote them carefully:

| Learning Type | Promote To | Example |
|---------------|------------|---------|
| Behavioral patterns | `CLAUDE.md` | "Always delegate deploy validation to Titan" |
| Workflow improvements | `AGENTS.md` or `CLAUDE.md` | "Run scripts/validate.sh after setup changes" |
| Tool gotchas | Project docs | "PM2 process name is animus-bot" |

Use short, durable rules. Do not paste raw logs or secrets into project memory.
